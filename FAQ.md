...
You can find more information at the [steamcache/sniproxy](https://github.com/steamcache/sniproxy) project page.
...
We prefer to use DNS-based interception This is because it is easier to deploy than other methods. Projects like [netcache-dns](https://github.com/macgyverbass/netcache-dns) and [steamcache-dns](https://github.com/steamcache/steamcache-dns) are docker images with a self-contained DNS server with options for setting your cache IP addresses.
...
* [macgyverbass/netcache-proxy](https://github.com/macgyverbass/netcache-proxy)
* [macgyverbass/netcache-dns](https://github.com/macgyverbass/netcache-dns)
* [steamcache/monolithic](https://github.com/steamcache/monolithic)
* [steamcache/generic](https://github.com/steamcache/generic)
* [steamcache/steamcache](https://github.com/steamcache/steamcache)
* [steamcache/sniproxy](https://github.com/steamcache/sniproxy)
